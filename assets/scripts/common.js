 ...
 * @returns Randomized number sequence as array.
 */
function generateRandomizedNumberSequenceArray( from, to ) {
	const numbers = [];
...
/**
 * Web-adjusted version of JS-Levenshtein.
...
function levenshtein( a, b ) {
    const _min = function(d0, d1, d2, bx, ay) {
        return d0 < d1 || d2 < d1
            ? d0 > d2
                ? d2 + 1
                : d0 + 1
